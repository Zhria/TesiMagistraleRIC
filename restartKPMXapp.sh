...
IMAGE_REPO="docker.io/zhria/kpm_app"
...
CONFIG_DIR="${BASE_ROOT}/kpm_basic_xapp/config"
...
usage(){
  cat <<USAGE
Usage: restartKPMXapp.sh
  Questo script reinstalla kpm-basic-xapp usando l'immagine
  ${IMAGE_REPO} con il tag indicato nel config-file.json del kpm_basic_xapp.
