...
class XappKpmFrame(RMRXapp):
    ...
    def __init__(self, xapp_name, address, port):
        ...
        self.uri_subscriptions = Values.GENERAL_PATH.format(Values.PLT_NAMESPACE, Values.SUBSCRIPTION_SERVICE,Values.PLT_NAMESPACE, Values.SUBSCRIPTION_PORT) + "/ric/v1/subscriptions"
        ...
        self.e2mgr_link = Values.GENERAL_PATH.format(Values.PLT_NAMESPACE, Values.E2MGR_SERVICE, Values.PLT_NAMESPACE, Values.E2MGR_PORT) + "/v1/nodeb/"
